...
function s.initial_effect(c)
    ...
    e2:SetCondition(function(e)
        ...
        return s.effcon(c, 6007213) and Duel.GetTurnPlayer() == e:GetHandlerPlayer()
    end)
    ...
    e3:SetCondition(function(e)
        local c = e:GetHandler()
        return s.effcon(c, 32491822) and Duel.GetTurnPlayer() == e:GetHandlerPlayer()
    end)
    e3:SetValue(4000)
    c:RegisterEffect(e3)
    local e3b = e3:Clone()
    ...
    e4:SetCondition(function(e)
        local c = e:GetHandler()
        return s.effcon(c, 69890967) and Duel.GetTurnPlayer() == e:GetHandlerPlayer()
    end)
    e4:SetValue(4000)
    c:RegisterEffect(e4)
