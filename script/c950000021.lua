...
function s.initial_effect(c)
    ...
    e3:SetCountLimit(1, id + 3000000, EFFECT_COUNT_CODE_OATH)
    ...
    e4:SetCountLimit(1, id + 4000000, EFFECT_COUNT_CODE_OATH)
    ...
    e5:SetCountLimit(1, id + 1000000, EFFECT_COUNT_CODE_OATH)
    e5:SetTarget(s.e5tg)
