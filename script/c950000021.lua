...
function s.initial_effect(c)
    ...
    e2:SetCountLimit(1, id + 2 * 1000000, EFFECT_COUNT_CODE_OATH)
    ...
    e3:SetCountLimit(1, id + 3 * 1000000, EFFECT_COUNT_CODE_OATH)
    ...
    e4:SetCountLimit(1, id + 4 * 1000000, EFFECT_COUNT_CODE_OATH)
    ...
    e5:SetCountLimit(1, id + 1 * 1000000, EFFECT_COUNT_CODE_OATH)
    e5:SetTarget(s.e5tg)
