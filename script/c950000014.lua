...
function s.initial_effect(c)
    ...
    me2:SetType(EFFECT_FLAG_DELAY + EFFECT_TYPE_FIELD + EFFECT_TYPE_TRIGGER_O)
    me2:SetProperty(EFFECT_FLAG_DAMAGE_STEP + EFFECT_FLAG_PLAYER_TARGET)
...
function s.me2tg(e, tp, eg, ep, ev, re, r, rp, chk)
    ...
    local sg = eg:Filter(s.me2filter2, nil, eg)
