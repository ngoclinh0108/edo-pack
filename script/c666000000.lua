...
function root.initial_effect(c)
	...
	act:SetProperty(EFFECT_FLAG_IGNORE_RANGE+EFFECT_FLAG_UNCOPYABLE+EFFECT_FLAG_CANNOT_DISABLE)
	...
	tobot:SetProperty(EFFECT_FLAG_IGNORE_RANGE+EFFECT_FLAG_UNCOPYABLE+EFFECT_FLAG_CANNOT_DISABLE)
	...
	e1:SetProperty(EFFECT_FLAG_IGNORE_RANGE+EFFECT_FLAG_DELAY+EFFECT_FLAG_DAMAGE_STEP)
	...
	e7:SetProperty(EFFECT_FLAG_IGNORE_RANGE)
	...
	e8:SetProperty(EFFECT_FLAG_IGNORE_RANGE)
	...
	e9:SetProperty(EFFECT_FLAG_IGNORE_RANGE)
	...
	e10:SetProperty(EFFECT_FLAG_IGNORE_RANGE)
